...
auth_blueprint.route('/update', methods=['POST'])(UserController.update_profile)#modifica datos del usuario. POST:  ya que estás enviando datos al servidor para cambiar la contraseña, en lugar de actualizar un recurso completo.
